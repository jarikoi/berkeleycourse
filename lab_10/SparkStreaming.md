...
*Note: We are many covering the DStream aspects of Spark Streaming. There is a new abstraction call Structured Streams, but that is still in Beta. The basic concepts are supported in never versions of Spark Streaming.*
